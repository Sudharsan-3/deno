  ...
  return (
    <div>
      ...
      <div>
        <button
          onClick={openModal}
          className="flex items-center gap-2 rounded-xl px-6 py-3 bg-gradient-to-r from-pink-600 to-pink-500 hover:from-pink-500 hover:to-pink-400 text-white text-sm sm:text-base font-semibold shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out"
        >
          <Image src={uploadIcon} alt="Upload Icon" className="w-5 h-5 invert" />
          Upload Transactions
        </button>
      </div>
      ...
      {show && (
        ...
        >
          <div
            className={`bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl w-[90%] max-w-lg p-6 sm:p-8 relative transform transition-all duration-300 border border-pink-200
